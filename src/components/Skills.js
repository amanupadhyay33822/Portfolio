...
const MySkills = [
  ...
  },
  {
    ...
    skills: [
        { name: "NodeJS", level: "Intermediate", icon:<BsFillPatchCheckFill /> },
        { name: "MongoDB", level: "Intermediate", icon:<BsFillPatchCheckFill /> },
        { name: "ExpressJS", level: "Intermediate", icon:<BsFillPatchCheckFill /> },
        { name: "MySQL", level: "Basic", icon:<BsFillPatchCheckFill /> },
        { name: "Git", level: "Basic", icon:<BsFillPatchCheckFill /> }
    ]
},
