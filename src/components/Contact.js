    ...
    <section id="Contact" ref={ref} className="py-12 md:ml-32 lg:ml-0">
      <div className="flex flex-col lg:flex-row justify-center items-start md:gap-10 px-4 sm:px-6 lg:px-8">
        <div className="md:mr-12 mt-8 md:mt-28 xxs:ml-8">
          ...
          <div className="flex flex-row justify-start text-2xl md:text-4xl mt-4 pb-3 gap-3">
            <a
              href="https://github.com/amanupadhyay33822"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/amanupadhyay007/"
              target="_blank"
              rel="noopener noreferrer"
            >
        ...
        <form
          ref={formRef}
          className="w-full max-w-lg bg-gray-50 shadow-md rounded-2xl px-4 pt-6 pb-8 mb-4"
          onSubmit={handleSubmit}
        >
          <div className="mb-6 mt-3 xxl:mt-6">
            <label
              className="block text-gray-700 text-sm font-bold mb-2 ml-3 xxl:text-xl "
              htmlFor="name"
            >
              Name
            </label>
          ...
          <div className="mb-6 xxl:mt-8">
            <label
              className="block text-gray-700 text-sm font-bold  xxl:text-xl mb-2 ml-3 "
              htmlFor="email"
            >
              Email
            </label>
      ...
      {showAlert && (
        <div
          role="alert"
          aria-live="assertive"
          className="fixed top-0 left-0 w-full flex items-center justify-center bg-green-500 text-white py-4"
        >
